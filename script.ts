...
function spawnEnemy(): Enemy {
    ...
    return { ...enemies[randomIndex] } as Enemy
...
function attackEnemy(attacker: Player | Enemy , defender: Player | Enemy, lower: number,upper: number): void {
...
let element = document.getElementById("attack-btn")! as HTMLButtonElement
let new_game = document.getElementById("new-game-btn")! as HTMLButtonElement
let potion = document.getElementById("use-potion")! as HTMLButtonElement
